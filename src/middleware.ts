...
export async function middleware(req: NextRequest) {
  ...
  // Rutas públicas
  if (pathname === "/inicio" || pathname === "/tienda" || pathname.startsWith("/tienda/") || pathname === "/agendar-gps" || pathname === "/encuesta" || pathname.startsWith("/firmar/")) return conPathname(req);
