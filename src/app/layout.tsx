...
export default async function RootLayout({
  ...
  const sinShell = pathname === "/login" || pathname === "/inicio" || pathname === "/tienda" || pathname.startsWith("/tienda/") || pathname === "/agendar-gps" || pathname === "/encuesta" || pathname.startsWith("/firmar/");
